...
volatility_rank_cs (cross-sectional 변동성 percentile)
...
volatility_rank_cs, volume_rank_cs (이미 §4.2/§4.3 포함, 중복 OK)
ma_distance_rank_cs (3 timeframes)
macd_rank_cs
...
| ID | 항목 | 추정 | 산출물 |
|----|------|:---:|--------|
| **ML-01** | 데이터 수집 (Upbit 250 + 상장폐지 + Binance global + CoinGecko historical) | 3d | parquet datasets |
