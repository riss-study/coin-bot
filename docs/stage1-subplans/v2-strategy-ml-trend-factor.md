...
- Train/test split (ML-01a 검증 후 정정 2026-04-27, CoinGecko free 365일 한도):
  * **학습**: 2024-01-01 ~ 2025-08-31 (20m)
  * **OOS**: 2025-09-01 ~ 2026-04-25 (8m)
  * **페이퍼 forward**: 2026-04-27 ~ (V2-06 운영 중)
- 데이터 source (정정): Upbit pyupbit (5년+) + Binance global BTC (5년+) + 한국은행/Yahoo USD/KRW 환율
- Survivorship bias 한계 박제: CoinGecko 무료 365일만 → 5년 상장폐지 코인 데이터 미수집. **baseline 70~80% 회피만**, 100% X. 학습 기간 24m 단축으로 1년+ 내 상장폐지 비율 낮음 (영향 완화)
