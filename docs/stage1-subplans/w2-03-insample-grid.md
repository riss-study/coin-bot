...
**상태**: **v8** (사용자 Option C 명시 채택 "ㄱㄱ" 2026-04-20 → V_empirical 채택 + Strategy A Recall 발동 박제). **변경 금지 서약 재조정**: 파라미터/공식/계산 방식 변경 X. DSR V 선택 해석만 "Bailey 2014 원문 V=trial SR sample variance" 로 정정 (자체 도입 floor 폐기). 외부 감사 +1회 수행 예정.
